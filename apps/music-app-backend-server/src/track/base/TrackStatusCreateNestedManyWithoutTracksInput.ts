...
@InputType()
class TrackStatusCreateNestedManyWithoutTracksInput {
...
export { TrackStatusCreateNestedManyWithoutTracksInput as TrackStatusCreateNestedManyWithoutTracksInput };
